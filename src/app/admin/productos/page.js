...
export default async function AdminProductosPage() {
  ...
  // Como aún no tenemos conexión real a DB en este paso local sin conf, 
  // esto podría dar error si la DB no está inicializada. 
  // Para evitar crashear la UI si no hay DB configurada, ponemos un try-catch.
  let products = [];
  let dbError = false;
